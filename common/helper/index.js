...
const helper = {
    genId() {
        return 'jmp-' + (0, uuid_1.v4)().substring(4);
    },
    ...
    shortenData(obj) {
        let data = lodash_1.default.cloneDeep(obj);
        if (lodash_1.default.isPlainObject(data)) {
            Object.keys(data).forEach(key => {
                if (lodash_1.default.isPlainObject(data[key]) || Array.isArray(data[key])) {
            ...
            if (lodash_1.default.isPlainObject(firstItem) || Array.isArray(firstItem)) {
    ...
    compareValueThenGetDiffProps(obj1, obj2) {
        // @ts-ignore
        return lodash_1.default.reduce(obj1, (result, value, key) => lodash_1.default.isEqual(value, obj2[key]) ? result : result.concat(key), []);
    },
    copy(value) {
        try {
